 ...
 * unique identifier that remains unique even after the object is deleted.
 * 
...
public class DataStore {
     ...
     * 
     * Note: we return -1 on an error. There are many good ways to handle an error,
     * to include throwing an exception. In robust code, returning -1 may not be the
     * most appropriate technique, but it is sufficient for this tutorial.
     * 
